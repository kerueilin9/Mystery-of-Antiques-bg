 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ll{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(hl(e)){const r=e.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(e=>e).join(" ")}}function hl(n){const t=n.getComponent();return(t==null?void 0:t.type)==="VERSION"}const ii="@firebase/app",lo="0.10.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yl(n){an(new ve("platform-logger",t=>new ll(t),"PRIVATE")),an(new ve("heartbeat",t=>new Ql(t),"PRIVATE")),Kt(ii,lo,n),Kt(ii,lo,"esm2017"),Kt("fire-js","")}Yl("");var Jl="firebase",Zl="10.12.3";/**
 * @license
